...
class DcmdInstall():
  def __init__(self):
    ...
    self.svr_docker_harbor_ip_ = os.environ.get('DCMD_SVR_SYS_image_url')
    self.svr_reg_user_ = os.environ.get('DCMD_SVR_SYS_image_user')
    self.svr_reg_passwd_ = os.environ.get('DCMD_SVR_SYS_image_passwd')
