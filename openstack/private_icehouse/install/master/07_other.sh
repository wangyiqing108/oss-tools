...
echo "1 3 * * 1 keystone-manage token_flush > /dev/null 2>&1" >> /var/spool/cron/root 
crontab -l
...
wget -q http://123.59.176.250:8080/Tools/ops-tools/openstack/zabbix/scripts/check_ceph.sh -O /usr/local/zabbix/script/check_ceph.sh  
wget -q http://123.59.176.250:8080/Tools/ops-tools/openstack/zabbix/scripts/check_rabbit.py -O /usr/local/zabbix/script/check_rabbit.py  
wget -q http://123.59.176.250:8080/Tools/ops-tools/openstack/zabbix/scripts/check_openstack_db.py -O /usr/local/zabbix/script/check_openstack_db.py  
wget -q http://123.59.176.250:8080/Tools/ops-tools/openstack/zabbix/scripts/check_openstack_api.py -O /usr/local/zabbix/script/check_openstack_api.py  
wget -q http://123.59.176.250:8080/Tools/ops-tools/openstack/zabbix/scripts/check_openstack_instances.sh -O /usr/local/zabbix/script/check_openstack_instances.sh

wget -q http://123.59.176.250:8080/Tools/ops-tools/openstack/zabbix/conf/check_db.conf -O /etc/zabbix/check_db.conf 
wget -q http://123.59.176.250:8080/Tools/ops-tools/openstack/zabbix/conf/check_api.conf -O /etc/zabbix/check_api.conf 
wget -q http://123.59.176.250:8080/Tools/ops-tools/openstack/zabbix/conf/check_rabbit.conf -O /etc/zabbix/check_rabbit.conf 

# Stastic Tools
wget -q http://123.59.176.250:8080/Tools/ops-tools/openstack/os-api -O /root/os-api
wget -q http://123.59.176.250:8080/Tools/ops-tools/openstack/os-static -O /root/os-static
chmod +x /root/os-api
chmod +x /root/os-static
