...
openstack-config --set /etc/glance/glance-api.conf DEFAULT workers 24
...
openstack-config --set /etc/glance/glance-api.conf database max_pool_size 5
openstack-config --set /etc/glance/glance-api.conf database max_overflow 15
