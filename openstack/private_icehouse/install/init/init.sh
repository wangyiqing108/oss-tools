...
#icehouse-5.0(4.1)
#havana
openstack_release="icehouse-6.0"
...
if [ "$openstack_release" == 'icehouse-6.0' ];then
    ...
    rpm -e letv-rdo-release-icehouse-4.1.noarch
    rpm -e letv-rdo-release-icehouse-5.0.noarch
    rpm -e libvirt-python-0.10.2-200.el6.89.letv.x86_64 libvirt-client-0.10.2-200.el6.89.letv.x86_64
    rpm -ivh http://115.182.93.170/repo/letv-rdo-release-icehouse-6.0.noarch.rpm --force
    if [ "$(cat /etc/issue|egrep "Compute|node"|wc -l)" == "1" ];then
        yum -y install libvirt-client-0.10.2-29.el6.88.x86_64.rpm libvirt-python-0.10.2-29.el6.88.x86_64.rpm libvirt-0.10.2-29.el6.88.x86_64 qemu-kvm-0.12.1.2-2.415.el6.89.x86_64 openstack-neutron-2014.1.3-14.el6.noarch openstack-neutron-ml2-2014.1.3-14.el6.noarch openstack-neutron-openvswitch-2014.1.3-14.el6.noarch openstack-nova-compute-2014.1.3-14.el6.noarch openstack-utils-2014.1-3.1.el6.noarch python-keystoneclient-0.9.0-1.el6.noarch python-memcached-1.53-1.el6.noarch python-neutronclient-2.3.4-10.el6.noarch 
        #yum -y install openstack-cinder-2014.1.3-10.el6.noarch openstack-ceilometer-common-2014.1.3-14.el6.noarch openstack-ceilometer-compute-2014.1.3-14.el6.noarch
    fi
